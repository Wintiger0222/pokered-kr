...
.sellMenuLoop
	...
	; set 6, [hl]
	coord hl, 1, 13
	ld de, Cleartext_hack
	call PlaceString
	coord hl, 1, 14
	ld de, Cleartext_hack
	call PlaceString
	coord hl, 1, 14
	ld de, PokemonSellingGreetingText_hack
	call PlaceString
	; pop hl
	; res 6, [hl]
.sellMenuLoophack
...
.buyMenuLoop
	...
	ld de, PokemartBuyingGreetingText_hack
	call PlaceString
	; pop hl
	; res 6, [hl]
.buyMenuLoophack
...
PokemonSellingGreetingText_hack:
	db "무엇을"
	next "판매하시겠습니까?@@"
	
PokemartBuyingGreetingText_hack:
	db "예! 여기 있습니다!@@"