...
; Namechangehackfuck_BattleMon: ;볼 던질때마다 이름 바뀌는것 방지
	; push de
	; push hl
	; ld de, wEnemyMonNick
	; coord hl, 4, 1
	; call CenterMonName_item
	; call PlaceString
	; pop hl
	; pop de
	; ret
Namechangehackfuck_EnemyMon:
	push de
	push hl
	jr monfuckhack
Namechangehackfuck: ;볼 던질때마다 이름 바뀌는것 방지
	push de
	push hl
...
.safariZone
	...
	call Namechangehackfuck_EnemyMon
	jr .skipSafariZoneCodehack
.skipSafariZoneCode
	call RunDefaultPaletteCommand
	...
	call LoadScreenTilesFromBuffer1
	call Namechangehackfuck
.skipSafariZoneCodehack
	ld hl, ItemUseText00
	call PrintText
