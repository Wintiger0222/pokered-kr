...
ELSE
	INCBIN "gfx/player_title_jp.2bpp"
ENDC
...
ELSE
CeruleanCave2F_Blocks: INCBIN "maps/CeruleanCave2F_jp.blk"
ENDC
...
ELSE
CeruleanCaveB1F_Blocks: INCBIN "maps/CeruleanCaveB1F_jp.blk"
ENDC
...
ELSE
Overworld_GFX:     INCBIN "gfx/tilesets/overworld-jp.2bpp"
ENDC
...
ELSE
CeruleanCave1F_Blocks: INCBIN "maps/CeruleanCave1F_jp.blk"
ENDC
...
SECTION "bank30",ROMX ;한글롬 확장을 위한 프로그램

INCLUDE "hangul/bank30.asm"

SECTION "bank30_fnt",ROMX ;폰트
Hangul_Font:
INCBIN "hangul/font30.fnt"

SECTION "bank31",ROMX ;폰트

INCBIN "hangul/font31.fnt"

SECTION "bank32",ROMX ;폰트

INCBIN "hangul/font32.fnt"

SECTION "bank33",ROMX ;폰트
Legacy_Font: 
