...
BlkPacket_PartyMenu:
	...
	ATTR_BLK_DATA %010, 0,0,0, 13,00, 18,01 ; HP bar 0: pal set dynamically
	ATTR_BLK_DATA %010, 0,0,0, 13,02, 18,03 ; HP bar 1: pal set dynamically
	ATTR_BLK_DATA %010, 0,0,0, 13,04, 18,05 ; HP bar 2: pal set dynamically
	ATTR_BLK_DATA %010, 0,0,0, 13,06, 18,07 ; HP bar 3: pal set dynamically
	ATTR_BLK_DATA %010, 0,0,0, 13,08, 18,09 ; HP bar 4: pal set dynamically
	ATTR_BLK_DATA %010, 0,0,0, 13,10, 18,11 ; HP bar 5: pal set dynamically
	ds 4
